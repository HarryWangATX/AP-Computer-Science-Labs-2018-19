...
// Lab Chapter 14 - #1  ArrayFunHouse    2019
...
public class ArrayFunHouseRunner
{
	...
	{
		System.out.println("Lab Chapter 14 - #1  ArrayFunHouse    2019");
		System.out.println();
		System.out.println();
		...
		System.out.println("new array with all 7s removed " + Arrays.toString(ArrayFunHouse.removeVals(one, 7)));
		System.out.println("# of 7s  =  " + ArrayFunHouse.getCount(ArrayFunHouse.removeVals(one, 7),7));
		System.out.println();
		System.out.println();
		...
		// add one more test case (make sure you use array variable two. Check the word doc for changes)
		...
		System.out.println("# of 4s  =  " + ArrayFunHouse.getCount(two,0));
		System.out.println("# of 9s  =  " + ArrayFunHouse.getCount(two,3));
		System.out.println("# of 7s  =  " + ArrayFunHouse.getCount(two,7));
		System.out.println("before removing all 7s " + Arrays.toString(two));
		System.out.println("stilp " + Arrays.toString(ArrayFunHouse.removeVals(two, 7)));
		System.out.println("# of 7s  =  " + ArrayFunHouse.getCount(ArrayFunHouse.removeVals(two, 7),7));
		System.out.println();
		System.out.println();
