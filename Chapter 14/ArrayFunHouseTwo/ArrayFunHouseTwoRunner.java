...
// Lab Chapter 14 - #2  ArrayFunHouseTwo    2019
...
public class ArrayFunHouseTwoRunner
{
	...
	{
		System.out.println("Lab Chapter 14 - #2  ArrayFunHouseTwo    2019");
		System.out.println();
		System.out.println();
		...
		System.out.println(Arrays.toString(four));
		ArrayList<Integer> updated = ArrayFunHouseTwo.getCountValuesBiggerThanX(four,7,9);
		System.out.println("first 7 values greater than 9  " + updated);
		updated = ArrayFunHouseTwo.getCountValuesBiggerThanX(four, 5, 15);
		System.out.println("first 5 values greater than 15  " + updated);
